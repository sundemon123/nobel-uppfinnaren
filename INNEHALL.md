# Vikingaresan: Havets folk — innehåll & konsekvenser
...
1. **Det återkommande stället.** Varje kapitel återvänder vi till
   samma småstad vid Östersjön — **Vindhamn**. Torget och hamnen ÄNDRAS
...
- Kapitel 4 öppnar med ett **upprorsutbrott** i Vindhamn (extra scen,
  inte game over).
...
> Vindhamn, en liten stad vid Östersjön. Här har folk fiskat, handlat och
...
I Vindhamn samlas folk på torget och viskar: ska vi följa honom?

**VAL 1 — Vad gör Vindhamn?**
1. *Skicka män med Gustav* — "Vindhamnborna tar sina yxor och följer.
...
Vindhamn står klostret och den gamle munken Brother Anders. Kungens
fogde kommer för att hämta kyrksilvret.

**VAL 1 — Var står Vindhamn?**
...
Danmark. I Vindhamn kommer Dackes budbärare: vill ni resa er med oss?

**VAL 1 — Vindhamn och upproret:**
...
Makt ≥ 6 och Folkets stöd ≤ 3 här → `overreach=true`, Vindhamn blir
...
- *Overreach:* Upproret slås ner brutalt. Vindhamn är tyst och rädd.
...
**[Overreach-öppning om aktiv]:** "Men i Vindhamn pyr oron. Skatterna för
...
Tyskland, och svenska soldater marscherar genom Europa. Vindhamn ligger
...
1. *Skicka Vindhamns unga män till kriget* — "Ära och byte lockar. Men
   många kommer aldrig hem." → Makt +2, Folkets stöd −1
2. *Satsa på handeln i stället* — "Medan andra krigar tjänar Vindhamn på
...
vardagen. I Vindhamn bor alla fyra stånden: greven på slottet, prästen i
...
I Vindhamn är hamnen tyst. Skeppen kommer inte hem. På torget brinner
ljus för de döda.

**Set-piece — Budet:** en ryttare kommer till Vindhamn med brevet om
...
1. *Ta hand om de sjuka och hemlösa* — "Vindhamn öppnar sina dörrar.
...
Östersjön. Vikingaresan är slut. Minne sitter tyst på tornet.

---

## KAPITEL 7 — Vad blev kvar (final + historiebruk)

**Recap:** "Stormakten föll. Men Vindhamn finns kvar. Och något lever
vidare."

**Scen:** Tiden hoppar ända fram till idag. Vindhamn är en modern liten
...
**"Vad hände på riktigt?"-ruta:** jämför spelarens Vindhamn-väg med den
...
påhittat (Vindhamn, Korpen Minne) och vad som hände på riktigt.
